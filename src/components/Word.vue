<template>
    <el-form id="page-content" ref="form" :model="form" label-width="80px">
        ...
        <el-form-item>
            <el-button class="word-export" type="primary" @click="onSubmit">立即创建</el-button>
...
import '../../static/jquery.wordexport.js'
export default {
    data() {
        return {
            msg: '测试jquery是否引入',
